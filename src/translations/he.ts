...
const heTranslations: Record<string, string> = {
  ...
  // New book - Bat/Beth
  'book.bat.title': 'בת ואות ב',
  'book.bat.description': 'ספר חדש ומרתק על בת ואות ב, עם איורים מקוריים שנוצרו באמצעות בינה מלאכותית ומתעוררים לחיים באמצעות טכנולוגיית מציאות רבודה.',
  'book.bat.story': 'בת מגלה את אות ב בעולם מלא הרפתקאות. הצטרפו אליה למסע מרתק של למידה ובגילוי',
