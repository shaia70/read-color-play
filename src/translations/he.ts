...
const heTranslations: Record<string, string> = {
  ...
  'book.newbrother.title': 'דניאל והאח החדש',
  'book.newbrother.description': 'כשאמא ואבא מספרים לדניאל שבקרוב יוולד לו אח קטן, הוא מרגיש הכל ביחד - שמחה, בלבול וקצת פחד',
  'book.newbrother.story': 'מה אם לא ישאר לו מקום בלב שלהם? מה אם התינוק יקח לו את כל מה שהוא אוהב? אבל אז, בלילה אחד קסום, הצעצועים האהובים שלו מתעוררים לחיים ומלמדים אותו שיעור חשוב במיוחד: אהבה לא נגמרת - היא רק גדלה. סיפור מרגש על משפחה, קבלה, ותפקידו הקסום של אח גדול',
