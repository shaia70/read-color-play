...
const heTranslations: Record<string, string> = {
  ...
  'book.newbrother.title': 'דניאל ואח החדש',
  'book.newbrother.description': 'ספר חדש ומרגש על דניאל ואחיו הקטן, עם איורים מקוריים שנוצרו באמצעות בינה מלאכותית ומתעוררים לחיים באמצעות טכנולוגיית מציאות רבודה.',
  'book.newbrother.story': 'דניאל מקבל אח חדש ומגלה כמה כיף להיות אח גדול. הצטרפו אליו למסע מרגש של אהבה משפחתית וחברות',
