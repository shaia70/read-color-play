          ...
          <div className={`grid grid-cols-1 ${isZoomed ? '' : 'md:grid-cols-2'} gap-6`}>
            ...
            >
              ...
              <div className="w-full flex flex-col items-center">
                ...
                <div 
                  className={`relative ${!isMobile ? "cursor-pointer" : "cursor-pointer"} transition-all duration-300 ease-in-out ${
                    imageState === "normal" 
                      ? "w-full max-w-md" 
              ...
              <div className={`absolute bottom-10 left-0 w-16 h-16 rounded-full bg-gradient-to-tr from-purple-200 to-purple-300 opacity-60 animate-float ${isMobile ? 'bottom-[25px]' : 'bottom-10'} ${isZoomed ? 'scale-150' : ''}`} style={{ animationDelay: "1.5s" }}></div>
            </motion.div>
          </div>
        </motion.div>
      </div>
