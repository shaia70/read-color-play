        ...
        >
          <div className={`grid grid-cols-1 ${isZoomed ? '' : 'md:grid-cols-2'} gap-6`}>
            ...
            >
              ...
              <div className={`absolute top-11 right-0 w-20 h-20 rounded-full bg-gradient-to-tr from-green-200 to-green-300 opacity-60 animate-float ${isZoomed ? 'scale-150' : ''}`}></div>
