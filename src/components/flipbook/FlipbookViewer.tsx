...
const FlipbookViewer = () => {
  ...
  // דמי נתונים - בפועל זה יהיה מ-PDF שהועלה
  const totalPages = 40;
  const pdfPages = Array.from({ length: totalPages }, (_, i) => 
    `/lovable-uploads/f3774be2-f5fb-45b0-a9e8-83e77df84a9e.png` // זמנית - אותה תמונה
  );
