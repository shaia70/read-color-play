...
interface ColoringPageActionsProps {
  imageSrc: string;
}

export function ColoringPageActions({ imageSrc }: ColoringPageActionsProps) {
    ...
    if (printWindow) {
      printWindow.document.write(`
        <html>
          ...
          <body>
            <img src="${imageSrc}" alt="${language === 'he' ? 'דף צביעה' : 'Coloring Page'}" />
            <script>
